                ...
                <div class="list-group-item">
                    <div class="row">
                        <div class="col-auto">
                            ...
                            <small>{{ \carbon\carbon::now()->isoFormat('D MMMM Y'); }} | Rit: {{ $mobil_tangki_item->harian_checklist()->whereDate('tanggal', now())->count() + 1 }}</small>
                        </div>
                        <div class="col-auto ml-auto align-self-center">
                            <a class="btn btn-primary" href="{{ route('checklist.harian.create', $mobil_tangki_item->id) }}">Buat</a>
                            <a class="btn btn-primary" href="{{ route('checklist.harian.show', $mobil_tangki_item->id) }}">Lihat</a>
                        </div>
                    </div>
                </div>
                @endforeach
